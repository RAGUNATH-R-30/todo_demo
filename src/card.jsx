...
function Card({ list, deletetask, changestatus, editlist, updatelist, buttonstate }) {
            ...
            <div className="card" style={{ width: "300px", backgroundColor: "#ccf5d3",border:"none"}}>
                <div className="card-body">
                    ...
                    <span>Status:<div className="btn-group">
                        <button type="button" className={`btn dropdown-toggle ${dropdowntoggle ? "show" : ""}`} data-bs-toggle="dropdown" aria-expanded="false" style={{ padding: 2, marginLeft: 8, backgroundColor: `${list.status == "completed" ? "#14ad89" : "#d76e6f"}`, opacity: 1, width: 120, fontSize: 14, color: "white" }} onClick={() => dropdown(!dropdowntoggle)}>
